...
<html>
    ...
    <body>
        <h1>WO 按選定日期列表</h1>            <basic:tag_index001/> 
         <%String strDate = request.getParameter("wodate");%>
         <br>工单录入日期︰<strong><%=strDate %></strong><br>
         <%
         ...
         %>
          <a href='qry001.jsp'>WO 按录入日期統計</a>
         <%--<%=basic.getHtmlTable(basic.getSql_woByDate(strDate))%>--%>
         <%=t100.getHtmlTable_wo_to_output(basic.getSql_woByDate(strDate))%>
